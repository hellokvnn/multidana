...
class PlnPlnController extends Controller
{
    /**
    ...
    {
        return view('dashboard.pln.pln.index', [
            "title" => "PLN PLN",
            "plnplns" => PlnPln::all()
        ]); 
    }
    ...
    {
        return view('dashboard.pln.pln.edit', [
            "title" => "PLN PLN Edit",
            'plnpln' => PlnPln::find($id)
        ]);
    }
