...
<div style="margin-top: 50px" class="container">
    <main class="form-signin">
        ...
        <div style="margin-left: 50px" class="container col-4 mb-4">
            <input style="border-color: #A00043 !important" type="text" name="nama" id="nama" class="form-control mb-4 border-bottom rounded-0" placeholder="Nama">
            <input style="border-color: #A00043 !important" type="text" name="username" id="username" class="form-control mb-4 border-bottom rounded-0" placeholder="Username">
            <input style="border-color: #A00043 !important" type="email" name="email" id="email" class="form-control mb-4 border-bottom rounded-0" placeholder="Email">
            <input style="border-color: #A00043 !important" type="password" name="password" id="password" class="form-control mb-4 border-bottom rounded-0" placeholder="Password">
        </div>
        <button style="background: #A00043; color:#fff; margin-left: 60px" class="btn" type="submit">SIGNUP</button>
