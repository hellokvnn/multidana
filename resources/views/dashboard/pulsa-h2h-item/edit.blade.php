...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li style="padding-left: 30px" class="nav-item">
                <a class="nav-link {{ ($title === "Axis Edit") ? 'active' : '' }}" href="/pulsa-retail-setting">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Edit Data {{$data->operator}}</h1>
                    ...
                    <a href="{{ route('pulsa-h2h-item', $data->pulsa_h2h_item_id) }}">
                        <img src="/images/back.png" alt="back">
                    </a>
                    
                    <div class="row">
                        <!-- Card Example -->
                        <form method="POST" action="{{route('pulsa-h2h-item-setting.update', $data->id )}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')

                            <input type="hidden" name="pulsa_h2h_item_id" value="{{ $data->pulsa_h2h_item_id }}">
                            ...
                            <div style="margin-top: 20px" class="card-body ml-5">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control" name="operator" value="{{$data->operator}}">
                                </div>
                                <div class="form-group mb-4">
