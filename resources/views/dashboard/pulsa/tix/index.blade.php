...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li style="padding-left: 30px" class="nav-item">
                <a class="nav-link {{ ($title === "Tix Retail") ? 'active' : '' }}" href="/pulsa-retail-setting">
            ...
            <li style="margin-top: -5px; padding-left: 30px" class="nav-item">
                <a class="nav-link" href="/format-transaksi-setting">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">TIX ID XXI</h1>
                    ...
                    <a href="{{route('tix-retail.create')}}" class="text-decoration-none">
                                ...
                                <tbody>
                                    @foreach ($tixes as $tix)
                                     <tr>
                                        ...
                                        <td> {{$tix->harga}} </td>
                                        <td>
                                            <a href="{{route('tix-retail.edit', $tix->id )}}" class="text-decoration-none">
