...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li style="padding-left: 30px" class="nav-item">
                <a class="nav-link {{ ($title === "Telkomsel Retail") ? 'active' : '' }}" href="/pulsa-retail-setting">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Telkomsel Nasional</h1>
                    ...
                    <a href="{{route('telkomsel-retail.create')}}" class="text-decoration-none">
                                ...
                                <tbody>
                                    @foreach ($telkomsels as $telkomsel)
                                     <tr>
                                        ...
                                        <td>
                                            <a href="{{route('telkomsel-retail.edit', $telkomsel->id )}}" class="text-decoration-none">
