        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 style="color: black" class="h3 mb-4">Tambah Indosat Nasional</h1>
                    <a href="/indosat-retail">
                    ...
                    <div class="row">
                        <!-- Card Example -->
                        <form method="POST" action="{{route('indosat-retail.store')}}" enctype="multipart/form-data">
                            @csrf
