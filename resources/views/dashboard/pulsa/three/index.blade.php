...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li style="padding-left: 30px" class="nav-item">
                <a class="nav-link {{ ($title === "Three Retail") ? 'active' : '' }}" href="/pulsa-retail-setting">
            ...
            <li style="margin-top: -5x; padding-left: 30px" class="nav-item">
                <a class="nav-link" href="/pulsa-h2h">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Three Nasional</h1>
                    ...
                    <a href="{{route('three-retail.create')}}" class="text-decoration-none">
                                ...
                                <tbody>
                                    @foreach ($threes as $three)
                                     <tr>
                                        ...
                                        <td> {{$three->harga}} </td>
                                        <td>
                                            <a href="{{route('three-retail.edit', $three->id )}}" class="text-decoration-none">
