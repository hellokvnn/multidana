        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Edit Layanan Multidana</h1>
                    ...
                    <a href="/layanan-setting">
                        <img src="/images/back.png" alt="back">
                    </a>

                    <div class="row">
                        <!-- Card Example -->
                        <form method="POST" action="{{route('layanan-setting.update', $layanan->id )}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div style="margin-top: 20px" class="card-body ml-5">
                                <div style="column-width: 650px" class="form-group mb-4">
                                    <label for="about">About</label>
                                    <textarea class="form-control" name="about" id="floatingTextarea2" style="height: 150px">{{$layanan->about}}</textarea>
                                </div>
                                <div class="form-group mb-4">
                                    <label for="service">Service</label>
                                    <textarea class="form-control" name="service" id="floatingTextarea2" style="height: 150px">{{$layanan->service}}</textarea>
                                </div>
                                <div class="form-group mb-4">
                                    <label for="produk">Produk</label>
                                    <textarea class="form-control" name="produk" id="floatingTextarea2" style="height: 150px">{{$layanan->produk}}</textarea>
                                </div>
