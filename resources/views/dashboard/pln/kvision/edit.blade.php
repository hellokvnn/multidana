...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li style="padding-left: 30px" class="nav-item">
                <a class="nav-link {{ ($title === "Kvision PLN Edit") ? 'active' : '' }}" href="/pulsa-retail-setting">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Edit Kvision Data</h1>
                    ...
                    <div class="row">
                        <!-- Card Example -->
                        <form method="POST" action="{{route('kvision-pln.update', $kvisionpln->id )}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div style="margin-top: 20px" class="card-body ml-5">
                                <div style="column-width: 650px" class="form-group mb-4">
                                    <label for="kode">Kode</label>
                                    <input type="text" class="form-control" name="kode" value="{{$kvisionpln->kode}}">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="operator">Operator</label>
                                    <input type="text" class="form-control" name="operator" value="{{$kvisionpln->operator}}">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="harga">Harga</label>
                                    <input type="number" class="form-control" name="harga" value="{{$kvisionpln->harga}}">
                                </div>
