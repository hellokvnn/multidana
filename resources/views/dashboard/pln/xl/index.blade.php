...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li style="padding-left: 30px" class="nav-item">
                <a class="nav-link {{ ($title === "XL PLN") ? 'active' : '' }}" href="/pulsa-retail-setting">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">XL HOTROD 24Jam</h1>
                    ...
                    <a href="{{route('xl-pln.create')}}" class="text-decoration-none">
                            ...
                            <table class="table text-center" id="dataTable" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> {{$xlpln->harga}}  </td>
                                        <td>
                                            <a href="{{route('xl-pln.edit', $xlpln->id )}}" class="text-decoration-none">
