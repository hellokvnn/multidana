...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li style="padding-left: 30px" class="nav-item">
                <a class="nav-link {{ ($title === "PLN Setting") ? 'active' : '' }}" href="/pulsa-retail-setting">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 style="color: black" class="h3 mb-4">PLN TV Kabel Data</h1>
                ...
                <div class="row justify-content-center">
                    <div class="col-2">
                        <a href="/indosat-pln" class="text-decoration-none">
                    ...
                    <div class="col-2">
                        <a href="/telkomsel-pln" class="text-decoration-none">
                        <div class="card-3" style="width: 217px; height: 170px">
                    ...
                    <div class="col-2">
                        <a href="/axis-pln" class="text-decoration-none">
                        <div class="card-3" style="width: 217px; height: 170px">
                    ...
                    <div class="col-2">
                        <a href="/xl-pln" class="text-decoration-none">
                        <div class="card-3" style="width: 217px; height: 170px">
                ...
                <div class="row justify-content-center">
                    <div class="col-2">
                        <a href="/smartfren-pln" class="text-decoration-none">
                        <div class="card-3" style="width: 217px; height: 170px">
                    ...
                    <div class="col-2">
                        <a href="/three-pln" class="text-decoration-none">
                        <div class="card-3" style="width: 217px; height: 170px">
                    ...
                    <div class="col-2">
                        <a href="/pln-pln" class="text-decoration-none">
                        <div class="card-3" style="width: 217px; height: 170px">
                    ...
                    <div class="col-2">
                        <a href="/kvision-pln" class="text-decoration-none">
                        <div class="card-3" style="width: 217px; height: 170px">
