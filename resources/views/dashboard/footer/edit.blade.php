    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li style="margin-top: -10px" class="nav-item pl-5">
                <a class="nav-link {{ ($title === "Layanan Edit") ? 'active' : '' }}" href="/layanan-setting">
                    <i class=""></i>
                    <span>Layanan</span></a>
            </li>
            ...
            <!-- Nav Item - Dashboard -->
            <li style="margin-top: -10px" class="nav-item pl-5">
                <a class="nav-link {{ ($title === "Tentang Edit") ? 'active' : '' }}" href="/tentang-setting">
                    <i class=""></i>
                    <span>Tentang</span></a>
            </li>
            ...
            <!-- Nav Item - Dashboard -->
            <li style="padding-left: 30px" class="nav-item">
                <a class="nav-link {{ ($title === "Tiket Kereta Edit") ? 'active' : '' }}" href="/pulsa-retail-setting">
            ...
            <li style="margin-top: 20px; padding-left: 30px" class="nav-item">
                <a class="nav-link {{ ($title === "Footer Edit") ? 'active' : '' }}" href="/footer-setting">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Edit Footer</h1>
                    ...
                    <a href="/footer-setting">
                        <img src="/images/back.png" alt="back">
                    </a>

                    <div class="row">
                        <!-- Card Example -->
                        <form method="POST" action="{{route('footer-setting.update', $footer->id )}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div style="margin-top: 20px" class="card-body ml-5">
                                <div style="column-width: 650px" class="form-group mb-4">
                                    <label for="logo">Logo</label>
                                    <input type="file" class="form-control" name="logo" value="{{$footer->logo}}">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="kota">Kota</label>
                                    <input type="text" class="form-control" name="kota" value="{{$footer->kota}}">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="alamat">Alamat</label>
                                    <textarea class="form-control" name="alamat" id="floatingTextarea2" style="height: 100px">{{$footer->alamat}}</textarea>
                                </div>
                                <div class="form-group mb-4">
                                    <label for="telp">Telepon</label>
                                    <input type="text" class="form-control" name="telp" value="{{$footer->telp}}">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="fax">Fax</label>
                                    <input type="text" class="form-control" name="fax" value="{{$footer->fax}}">
                                </div>
                                <div class="form-group mb-4">
                                ...
                                <div class="form-group mb-4">
                                    <label for="solution_centre">Solution Centre</label>
                                    <input type="text" class="form-control" name="solution_centre" value="{{$footer->solution_centre}}">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="no_whatsapp">No Whatsapp</label>
                                    <input type="text" class="form-control" name="no_whatsapp" value="{{$footer->whatsapp}}">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="link_whatsapp">Link Whatsapp</label>
                                    <textarea class="form-control" name="link_whatsapp" id="floatingTextarea2" style="height: 100px">{{$footer->link_whatsapp}}</textarea>
                                </div>
                                <div class="form-group mb-4">
                                    <label for="link_instagram">Link Instagram</label>
                                    <textarea class="form-control" name="link_instagram" id="floatingTextarea2" style="height: 100px">{{$footer->link_instagram}}</textarea>
                                </div>
                                <div class="form-group mb-4">
                                    <label for="link_twitter">Link Twitter</label>
                                    <textarea class="form-control" name="link_twitter" id="floatingTextarea2" style="height: 100px">{{$footer->link_twitter}}</textarea>
                                </div>
