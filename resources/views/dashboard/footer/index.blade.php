    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li style="margin-top: -10px" class="nav-item pl-5">
                <a class="nav-link {{ ($title === "Layanan") ? 'active' : '' }}" href="/layanan-setting">
                    <i class=""></i>
                    <span>Layanan</span></a>
            </li>
            ...
            <!-- Nav Item - Dashboard -->
            <li style="margin-top: -10px" class="nav-item pl-5">
                <a class="nav-link {{ ($title === "Tentang") ? 'active' : '' }}" href="/tentang-setting">
                    <i class=""></i>
                    <span>Tentang</span></a>
            </li>
            ...
            <!-- Nav Item - Dashboard -->
            <li style="padding-left: 30px" class="nav-item">
                <a class="nav-link {{ ($title === "Tiket Kereta") ? 'active' : '' }}" href="/pulsa-retail-setting">
            ...
            <li style="margin-top: 20px; padding-left: 30px" class="nav-item">
                <a class="nav-link {{ ($title === "Footer") ? 'active' : '' }}" href="/footer-setting">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Footer</h1>
                            ...
                            <table class="table" id="dataTable" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Solution Centre</th>
                                    </tr>
                                </thead >
                                <tbody>
                                    @foreach ($footers as $footer)
                                     <tr>
                                        <td> <img src="{{asset('storage/' . $footer->logo)}}" alt=""> </td>
                                        <td> {{$footer->kota}} </td>
                                        <td> {{$footer->alamat}} </td>
                                        <td> {{$footer->telp}} </td>
                                        <td> {{$footer->fax}} </td>
                                        <td> {{$footer->email}} </td>
                                        <td> {{$footer->solution_centre}} </td>
                                     </tr>
                                     @endforeach
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    @foreach ($footers as $footer)
                                     <tr>
                                        ...
                                        <td> {{$footer->link_whatsapp}} </td>
                                        <td> {{$footer->link_instagram}} </td>
                                        <td> {{$footer->link_twitter}} </td>
                                      </tr>
                                     @endforeach
                                </tbody>
                            </table>
                            <div class="text-center">
                                <a href="{{route('footer-setting.edit', $footer->id )}}" class="text-decoration-none">
