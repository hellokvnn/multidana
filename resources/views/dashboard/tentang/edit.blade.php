        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Edit Tentang Multidana</h1>
                    ...
                    <a href="/tentang-setting">
                        <img src="/images/back.png" alt="back">
                    </a>

                    <div class="row">
                        <!-- Card Example -->
                        <form method="POST" action="{{route('tentang-setting.update', $tentang->id )}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div style="margin-top: 20px" class="card-body ml-5">
                                <div style="column-width: 650px" class="form-group mb-4">
                                    <label for="judul">Judul</label>
                                    <input type="text" class="form-control" name="judul" value="{{$tentang->judul}}">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="text">Text</label>
                                    <textarea class="form-control" name="text" id="floatingTextarea2" style="height: 150px">{{$tentang->text}}</textarea>
                                </div>
                                <div class="form-group mb-4">
                                    <label for="link">Link Youtube Embed</label>
                                    <textarea class="form-control" name="link" id="floatingTextarea2" style="height: 140px">{{$tentang->link}}</textarea>
                                </div>
