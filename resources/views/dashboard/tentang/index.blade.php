        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Tentang Multidana</h1>
                            ...
                            <table class="table" id="dataTable" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Link Youtube Embed</th>
                                        <th scope="col"></th>
                                    </tr>
                                </thead >
                                <tbody>
                                    @foreach ($tentangs as $tentang)
                                     <tr>
                                        ...
                                        <td> {{$tentang->link}} </td>
                                        <td>
                                            <a href="{{route('tentang-setting.edit', $tentang->id )}}" class="text-decoration-none">
