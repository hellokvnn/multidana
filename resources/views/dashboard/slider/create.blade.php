    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item pl-5">
                <a class="nav-link active" href="/slider-setting">
                    <i class=""></i>
                    <span>Slider</span></a>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Tambah Slider</h1>
                    ...
                    <div class="row">
                        <!-- Card Example -->
                        <form method="POST" action="{{route('slider-setting.store')}}" enctype="multipart/form-data">
                            @csrf
