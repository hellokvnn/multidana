...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li style="margin-top: -10px" class="nav-item pl-5">
                <a class="nav-link" href="/profil-aplikas-setting">
                    <i class=""></i>
            ...
            <!-- Nav Item - Dashboard -->
            <li style="padding-left: 30px" class="nav-item">
                <a class="nav-link {{ ($title === "Telkom Multibiller") ? 'active' : '' }}" href="/pulsa-retail-setting">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Telkom Multibiller</h1>
                    ...
                    <a href="/multibiller-setting">
                        <img src="/images/back.png" alt="back">
                    </a>

                    <div class="row col">
                    <a href="{{route('telkom-multibiller.create')}}" class="text-decoration-none">
                            ...
                            <table class="table text-center" id="dataTable" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('telkom-multibiller.edit', $telkommultibiller->id )}}" class="text-decoration-none">
