...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li style="padding-left: 30px" class="nav-item">
                <a class="nav-link {{ ($title === "Telkom Multibiller Edit") ? 'active' : '' }}" href="/pulsa-retail-setting">
            ...
            <li style="margin-top: -5px; padding-left: 30px" class="nav-item">
                <a class="nav-link" href="/format-setting">
                    <i class=""><img src="/images/pulsah2h.pngs" alt="formattransaksi"></i>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Edit Telkom Multibiller</h1>
                    ...
                    <a href="/telkom-multibiller">
                        <img src="/images/back.png" alt="back">
                    </a>

                    <div class="row">
                        <!-- Card Example -->
                        <form method="POST" action="{{route('telkom-multibiller.update', $telkommultibiller->id )}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div style="margin-top: 20px" class="card-body ml-5">
                                <div style="column-width: 650px" class="form-group mb-4">
                                    <label for="kode">Kode</label>
                                    <input type="text" class="form-control" name="kode" value="{{$telkommultibiller->kode}}">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="operator">Operator</label>
                                    <input type="text" class="form-control" name="operator" value="{{$telkommultibiller->operator}}">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="harga">Harga</label>
                                    <input type="number" class="form-control" name="harga" value="{{$telkommultibiller->harga}}">
                                </div>
