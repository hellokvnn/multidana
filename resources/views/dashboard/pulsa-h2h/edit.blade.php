    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li style="padding-left: 30px; margin-bottom: -5px" class="nav-item">
                <a class="nav-link {{ ($title === "Pulsa Telepon Setting") ? 'active' : '' }}" href="/pulsa-retail-setting">
             ...
             <li style="margin-top: -5x; padding-left: 30px" class="nav-item">
                <a class="nav-link activeeee" href="/pulsa-h2h-setting">
                    <i class=""><img src="/images/pulsah2h.png" alt="pulsah2h"></i>
                    <span>Pulsa House to House</span></a>
            </li>

            <!-- Nav Item - Dashboard -->
            <li style="margin-top: 1px; padding-left: 30px" class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 style="color: black" class="h3 mb-4">Pulsa Telepon</h1>
                ...
                <div class="row justify-content-center">
                    @foreach ($data as $item)
                        <div style="margin-left: 50px" class="col-2">
                            <a href="/pulsa-h2h-item/{{ $item->id }}" class="text-decoration-none">
                    ...
                    @endforeach
                    <!-- <div class="col-2">
                        <a href="/indosat-retail" class="text-decoration-none">
                        <div class="card-3" style="width: 217px; height: 170px">
                    ...
                    <div class="col-2">
                        <a href="/telkomsel-retail" class="text-decoration-none">
                        <div class="card-3" style="width: 217px; height: 170px">
                    ...
                    <div class="col-2">
                        <a href="/axis-retail" class="text-decoration-none">
                        <div class="card-3" style="width: 217px; height: 170px">
                    ...
                    <div class="col-2">
                        <a href="/xl-retail" class="text-decoration-none">
                        <div class="card-3" style="width: 217px; height: 170px">
                ...
                <div class="row justify-content-center">
                    <div class="col-2">
                        <a href="/smartfren-retail" class="text-decoration-none">
                        <div class="card-3" style="width: 217px; height: 170px">
                    ...
                    <div class="col-2">
                        <a href="/three-retail" class="text-decoration-none">
                        <div class="card-3" style="width: 217px; height: 170px">
                    ...
                    <div class="col-2">
                        <a href="/mtix-retail" class="text-decoration-none">
                        <div class="card-3" style="width: 217px; height: 170px">
                    ...
                    <div class="col-2">
                        <a href="/tix-retail" class="text-decoration-none">
                        <div class="card-3" style="width: 217px; height: 170px">
