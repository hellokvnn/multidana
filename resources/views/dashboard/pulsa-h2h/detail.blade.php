...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li style="margin-top: -10px" class="nav-item pl-5">
                <a class="nav-link" href="/tentang-aplikasi">
                    <i class=""></i>
                    <span>Tentang</span></a>
            </li>
            ...
            <li style="padding-left: 30px; margin-bottom: -5px" class="nav-item">
                <a class="nav-link {{ ($title === "Axis PLN") ? 'active' : '' }}" href="/pulsa-retail-setting">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">{{ $data[0]->title }}</h1>
                    ...
                    <a href="{{ route('pulsa-h2h-setting.edit', $data[0]->id) }}">
                        <img src="/images/back.png" alt="back">
                    </a>

                    <a href="{{route('pulsa-h2h-item-setting.show', $data[0]->id)}}" class="text-decoration-none">
                            ...
                            <table class="table text-center" id="dataTable" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('pulsa-h2h-item-setting.edit', $item->id )}}" class="text-decoration-none">
