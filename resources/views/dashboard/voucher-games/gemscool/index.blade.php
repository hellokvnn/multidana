...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li style="padding-left: 30px" class="nav-item">
                <a class="nav-link {{ ($title === "Gemscool") ? 'active' : '' }}" href="/pulsa-retail-setting">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Gemscool</h1>
                    ...
                    <a href="{{route('gemscool-voucher-games.create')}}" class="text-decoration-none">
                                ...
                                <tbody>
                                    @foreach ($gemscools as $gemscool)
                                     <tr>
                                        ...
                                        <td>
                                            <a href="{{route('gemscool-voucher-games.edit', $gemscool->id )}}" class="text-decoration-none">
