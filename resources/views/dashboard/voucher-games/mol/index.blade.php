...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li style="padding-left: 30px" class="nav-item">
                <a class="nav-link {{ ($title === "Mol") ? 'active' : '' }}" href="/pulsa-retail-setting">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Mol Point</h1>
                    ...
                    <div class="row col">
                    <a href="{{route('mol-voucher-games.create')}}" class="text-decoration-none">
                                ...
                                <tbody>
                                    @foreach ($mols as $mol)
                                     <tr>
                                        ...
                                        <td> {{$mol->harga}} </td>
                                        <td>
                                            <a href="{{route('mol-voucher-games.edit', $mol->id )}}" class="text-decoration-none">
