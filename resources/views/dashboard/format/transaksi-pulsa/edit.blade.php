    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li style="margin-top: -5px; padding-left: 30px" class="nav-item">
                <a class="nav-link {{ ($title === "Transaksi Pulsa Edit") ? 'active' : '' }}" href="#">
                        ...
                        <form method="POST" action="{{route('transaksi-pulsa-format.update', $transaksipulsa->id )}}" enctype="multipart/form-data">
                            ...
                            <div style="margin-top: 20px" class="card-body ml-5">
                                <div style="column-width: 650px" class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control" name="kode" value="{{$transaksipulsa->kode}}">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="operator">Operator</label>
                                    <input type="text" class="form-control" name="operator" value="{{$transaksipulsa->operator}}">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="harga">Harga</label>
                                    <input type="number" class="form-control" name="harga" value="{{$transaksipulsa->harga}}">
                                </div>
