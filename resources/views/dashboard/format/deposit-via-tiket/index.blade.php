...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li style="margin-top: -5px; padding-left: 30px" class="nav-item">
                <a class="nav-link {{ ($title === "Deposit Via Tiket") ? 'activee' : '' }}" href="/format-setting">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Deposit Via Tiket Format</h1>
                        ...
                        <div class="card-body">
                            <table class="table text-center" id="dataTable" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td> {{$depositviatiket->format}} </td>
                                        <td> {{$depositviatiket->contoh}} </td>
                                        <td> {{$depositviatiket->title}} </td>
                                        <td> {{$depositviatiket->desc}}  </td>
                                        <td>
                                            <a href="{{route('deposit-via-tiket-format.edit', $depositviatiket->id )}}" class="text-decoration-none">
