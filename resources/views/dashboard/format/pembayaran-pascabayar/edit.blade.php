                        ...
                        <form method="POST" action="{{route('pembayaran-pascabayar-format.update', $pembayaranpascabayar->id )}}" enctype="multipart/form-data">
                            ...
                            <div style="margin-top: 20px" class="card-body ml-5">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control" name="title" value="{{$pembayaranpascabayar->title}}">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="desc">Description</label>
                                    <textarea class="form-control" style="height: 100px;" name="desc"> {{$pembayaranpascabayar->desc}} </textarea>
                                </div>
