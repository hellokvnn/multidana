...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li style="margin-top: -5px; padding-left: 30px" class="nav-item">
                <a class="nav-link {{ ($title === "Rekap Transaksi") ? 'activee' : '' }}" href="/format-setting">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Rekap Transaksi Format</h1>
                        ...
                        <div class="card-body">
                            <table class="table text-center" id="dataTable" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td> {{$rekaptransaksi->format}} </td>
                                        <td> {{$rekaptransaksi->contoh}} </td>
                                        <td> {{$rekaptransaksi->title}} </td>
                                        <td> {{$rekaptransaksi->desc}}  </td>
                                        <td>
                                            <a href="{{route('rekap-transaksi-format.edit', $rekaptransaksi->id )}}" class="text-decoration-none">
