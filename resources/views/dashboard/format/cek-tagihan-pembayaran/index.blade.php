...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li style="margin-top: -5px; padding-left: 30px" class="nav-item">
                <a class="nav-link {{ ($title === "Cek Tagihan Pembayaran") ? 'activee' : '' }}" href="/format-setting">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Cek Tagihan Pembayaran Format</h1>
                        ...
                        <div class="card-body">
                            <table class="table text-center" id="dataTable" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td> {{$cektagihanpembayaran->format}} </td>
                                        <td> {{$cektagihanpembayaran->contoh}} </td>
                                        <td> {{$cektagihanpembayaran->title}} </td>
                                        <td> {{$cektagihanpembayaran->desc}}  </td>
                                        <td>
                                            <a href="{{route('cek-tagihan-pembayaran-format.edit', $cektagihanpembayaran->id )}}" class="text-decoration-none">
