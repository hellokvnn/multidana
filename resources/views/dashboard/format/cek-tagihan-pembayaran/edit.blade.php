...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li style="margin-top: -5px; padding-left: 30px" class="nav-item">
                <a class="nav-link {{ ($title === "Cek Tagihan Pembayaran Edit") ? 'activee' : '' }}" href="/format-setting">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Edit Cek Tagihan Pembayaran Format</h1>
                    ...
                    <a href="/cek-tagihan-pembayaran-format">
                        <img src="/images/back.png" alt="back">
                    </a>

                    <div class="row">
                        <!-- Card Example -->
                        <form method="POST" action="{{route('cek-tagihan-pembayaran-format.update', $cektagihanpembayaran->id )}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div style="margin-top: 20px" class="card-body ml-5">
                                <div style="column-width: 650px" class="form-group mb-4">
                                    <label for="format">Format</label>
                                    <input type="text" class="form-control" name="format" value="{{$cektagihanpembayaran->format}}">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="contoh">Contoh</label>
                                    <input type="text" class="form-control" name="contoh" value="{{$cektagihanpembayaran->contoh}}">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="title">Judul</label>
                                    <input type="text" class="form-control" name="title" value="{{$cektagihanpembayaran->title}}">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="desc">Description</label>
                                    <textarea class="form-control" style="height: 100px;" name="desc"> {{$cektagihanpembayaran->desc}} </textarea>
                                </div>
