    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li style="margin-top: -5px; padding-left: 30px" class="nav-item">
                <a class="nav-link  {{ ($title === "Format Setting") ? 'activee' : '' }}" href="/format-setting">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="row justify-content-center">
                    <div class="col-2">
                        <a href="/transaksi-pulsa-format" class="text-decoration-none">
                        <div class="card-5" style="width: 217px; height: 160px">
                    ...
                    <div class="col-2">
                        <a href="/cek-saldo-format" class="text-decoration-none">
                        <div class="card-5" style="width: 217px; height: 160px">
                    ...
                    <div class="col-2">
                        <a href="/deposit-via-tiket-format" class="text-decoration-none">
                        <div class="card-5" style="width: 217px; height: 160px">
                    ...
                    <div class="col-2">
                        <a href="/ganti-pin-format" class="text-decoration-none">
                        <div class="card-5" style="width: 217px; height: 160px">
                ...
                <div class="row justify-content-center">
                    <div class="col-2">
                        <a href="/rekap-transaksi-format" class="text-decoration-none">
                        <div class="card-5" style="width: 217px; height: 160px">
                    ...
                    <div class="col-2">
                        <a href="/komplain-format" class="text-decoration-none">
                        <div class="card-5" style="width: 217px; height: 160px">
                    ...
                    <div class="col-2">
                        <a href="/cek-tagihan-pembayaran-format" class="text-decoration-none">
                        <div class="card-5" style="width: 217px; height: 160px">
                    ...
                    <div class="col-2">
                        <a href="/pembayaran-pascabayar-format" class="text-decoration-none">
                        <div class="card-5" style="width: 217px; height: 160px">
                ...
                <div class="row justify-content-center">
                    <div class="col-2">
                        <a href="/cek-harga-produk-format" class="text-decoration-none">
                            <div class="card-5" style="width: 217px; height: 160px">
                    ...
                    <div class="col-2">
                        <a href="/transfer-deposit-format" class="text-decoration-none">
                            <div class="card-5" style="width: 217px; height: 160px">
                    ...
                    <div class="col-2">
                        <a href="/markup-global-format" class="text-decoration-none">
                            <div class="card-5" style="width: 217px; height: 160px">
                    ...
                    <div class="col-2">
                        <a href="/markup-spesifik-format" class="text-decoration-none">
                            <div class="card-5" style="width: 217px; height: 160px">
