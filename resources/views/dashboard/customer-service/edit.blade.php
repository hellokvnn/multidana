    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li style="margin-top: -10px; padding-left: 30px" class="nav-item">
                <a class="nav-link {{ ($title === "Customer Service Setting Edit") ? 'activeee' : '' }}" href="/customer-service-setting">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Customer Service Setting Edit</h1>
                    ...
                    <div class="row">
                        <!-- Card Example -->
                        <form method="POST" action="{{route('customer-service-setting.update', $customerservicesetting->id )}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
