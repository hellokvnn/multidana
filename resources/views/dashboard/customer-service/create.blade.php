...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li style="margin-top: -10px" class="nav-item pl-5">
                <a class="nav-link" href="/profil-setting">
                    <i class=""></i>
            ...
            <li style="margin-top: -10px; padding-left: 30px" class="nav-item">
                <a class="nav-link activeee" href="customer-service-setting">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Customer Service Setting Add</h1>
                    ...
                    <a href="/customer-service-setting">
                        <img src="/images/back.png" alt="back">
                    </a>

                    <div class="row">
                        <!-- Card Example -->
                        <form method="POST" action="{{route('customer-service-setting.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div style="margin-top: 20px" class="card-body ml-5">
                                ...
                                <button style="margin-left: 550px" type="submit" class="btn btn-success">Tambah</button>
                            </div>
                        </form>
                    </div>
                </div>
