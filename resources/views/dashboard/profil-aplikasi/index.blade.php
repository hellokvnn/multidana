...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li style="margin-top: -10px" class="nav-item pl-5">
                <a class="nav-link {{ ($title === "Profil Aplikasi") ? 'active' : '' }}" href="/profi-aplikasi-setting">
                    <i class=""></i>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Profil Aplikasi</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="card-body">
                            <table class="table" id="dataTable" width="100%">
                                ...
                                <tbody>
                                     <tr>
                                        ...
                                        <td> {{$profilaplikasi->text}} </td>
                                        <td> {{$profilaplikasi->link}} </td>
                                        @endforeach
                                        <td>
                                            <a href="{{route('profil-aplikasi-setting.edit', $profilaplikasi->first())}}" class="text-decoration-none">
                            ...
                            <h1 style="color: black" class="h3 mb-5 mt-5">Slider</h1>
