...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li style="margin-top: -10px" class="nav-item pl-5">
                <a class="nav-link {{ ($title === "Profil Aplikasi Edit") ? 'active' : '' }}" href="/profil-aplikasi-setting">
                    <i class=""></i>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Edit Profil Aplikasi</h1>
                    ...
                    <a href="/profil-aplikasi-setting">
                        <img src="/images/back.png" alt="back">
                    </a>

                    <div class="row">
                        <!-- Card Example -->
                        <form method="POST" action="{{route('profil-aplikasi-setting.update', $profilaplikasi->id )}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div style="margin-top: 20px" class="card-body ml-5">
                                <div style="column-width: 650px" class="form-group mb-4">
                                    <label for="text">Text</label>
                                    <textarea class="form-control" name="text" id="floatingTextarea2" style="height: 150px">{{$profilaplikasi->text}}</textarea>
                                </div>
                                <div class="form-group mb-4">
                                    <label for="link">Link</label>
                                    <textarea class="form-control" name="link" id="floatingTextarea2" style="height: 100px">{{$profilaplikasi->link}}</textarea>
                                </div>
                                <div class="form-group mb-4">
                                    <label for="foto">Foto</label>
                                    <input class="form-control" type="file" id="foto" name="foto" value="{{asset('storage/slider/') . $profilaplikasi->foto}}">
                                </div>
