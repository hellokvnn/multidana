...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li style="margin-top: -10px" class="nav-item pl-5">
                <a class="nav-link" href="/profi-aplikasi-setting">
                    <i class=""></i>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div>
                        <h1 style="color: black" class="h3 mb-4">Tiket Kereta</h1>
                    ...
                    <a href="/pulsa-retail-setting">
                        <img src="/images/back.png" alt="back">
                    </a>

                    <div class="row col">
                    <a href="{{route('tiket-kereta-setting.create')}}" class="text-decoration-none">
                                ...
                                <tbody>
                                    @foreach ($tiketkeretas as $tiketkereta)
                                     <tr>
                                        ...
                                        <td>
                                            <a href="{{route('tiket-kereta-setting.edit', $tiketkereta->id )}}" class="text-decoration-none">
