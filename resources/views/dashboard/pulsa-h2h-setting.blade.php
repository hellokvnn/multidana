    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #A00043" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li style="margin-top: -5px; padding-left: 30px" class="nav-item">
                <a class="nav-link {{ ($title === "Pulsa H2H Setting") ? 'activeeee' : '' }}" href="/pulsa-h2h-setting">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 style="color: black" class="h3 mb-4">Pulsa House to House</h1>
                    ...
                    <div class="row justify-content-center">
                      @foreach($data as $item)
                        <div class="col-sm-3">
                          <a href={{ route("pulsa-h2h-setting.edit", $item->id) }} class="text-decoration-none">
                          <div class="card-1" style="width: 20rem; height: 17rem">
                            <img src="{{ $item->image }}" class="card-img-top rounded mx-auto d-block" alt="hp" >
                            <div class="card-body">
                              <h4>{{ $item->title }}</h4>
                            </div>
                          </div>
                      ...
                      @endforeach
                        ...
                        <!-- <div class="col-sm-3">
                          <a href="/pulsa-telepon-h2h-setting" class="text-decoration-none">
                          <div class="card-1" style="width: 20rem; height: 17rem">
                        ...
                        <div class="col-sm-3">
                          <a href="/pln-h2h-setting" class="text-decoration-none">
                          <div class="card-1" style="width: 20rem; height: 17rem">
                        ...
                        <div class="col-sm-3">
                          <a href="/voucher-games-h2h-setting" class="text-decoration-none">
                          <div class="card-1" style="width: 20rem; height: 17rem">
